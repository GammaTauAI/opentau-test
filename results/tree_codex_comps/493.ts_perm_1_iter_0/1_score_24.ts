var getAllElements: (root1: { val: number; left: { val: number; left: any; right: any; }; right: { val: number; left: any; right: any; }; }, root2: { val: number; left: { val: number; left: any; right: any; }; right: { val: number; left: any; right: any; }; }) => number[] = function (root1, root2) {
    ...
    return res;
    function traverse(node: { val: number; left: { val: number; left: any; right: any; }; right: { val: number; left: any; right: any; }; }, set: Set<number>): void {
        if (node == null)
            return;
