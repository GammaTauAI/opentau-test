const countRectangles: (rectangles: [[number, number]], points: [[number, number]]) => number[] = function (rectangles, points) {
    const rect: [[number, number]] = rectangles;
