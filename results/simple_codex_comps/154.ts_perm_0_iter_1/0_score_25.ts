const scheduleCourse: Function = function (courses) {
...
const getParent: Function = (i) => Math.floor((i - 1) / 2);
const getLeft: Function = (i) => 2 * i + 1;
const getRight: Function = (i) => 2 * i + 2;
class Heap {
    compare: Function;
    _heap: number[];
    constructor() {
